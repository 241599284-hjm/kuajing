...
- 2026-06-22：后台全局搜索已发布测试服务器。真实 owner 搜索“白瓷”返回 `TEA-PORCELAIN-SET-001`，选择结果后商品列表按该 SKU 重新请求并只显示一行；无会话聚合搜索返回 401。最终 release `20260622115615-557db6502781`，previous `20260622115243-0ab5d78c598f`。
