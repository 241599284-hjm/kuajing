...
- 测试服务器已部署 release `20260621152929-4a9fbf5d60d0`，上一版为 `20260621023000-f02b13cf9edf`：订单单行列表/单实例详情弹窗、服务端筛选/分页、首页 10 模块、三件 Catalog 商品、订阅运营、管理员登录和 PayPal 配置后台均通过相应验证。浏览器认证统一使用同源 `/auth`，无需开放 auth-service 端口。
