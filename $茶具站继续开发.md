...
3. 继续扩大统一业务错误码接入范围：`@commerce/error-codes` 包和网关归一化已有第一版，下一步把 catalog/media/order/inventory/review/logistics/notification 的核心异常逐步替换为标准 `code/message/details`。
