...
- 测试服务器已部署 release `20260621115408-c7e1629d15d0`，回滚版本为 `20260621152929-4a9fbf5d60d0`：订单、退款、Webhook、客户、商品和评价列表的统一详情交互，以及前台商品详情和首页 WebP 素材已上线。真实 API 与服务健康检查通过；本轮公网浏览器连接连续超时，线上双端视觉复验仍保留为未验证项。浏览器认证统一使用同源 `/auth`，无需开放 auth-service 端口。
