...
import { VisitorAnalyticsDashboard } from "./visitor-analytics-dashboard.js";
...
const groups: Array<{ label?: string; items: NavItem[] }> = [
  { items: [{ id:"dashboard",label:"数据仪表盘",icon:BarChart3 },{id:"visitorAnalytics",label:"访问监控",icon:Activity},{id:"serverStatus",label:"服务器状态",icon:Server}] },
